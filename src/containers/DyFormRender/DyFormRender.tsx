...
function DynamicForm({ fieldSlug, fieldValue }: DynamicFormProps) {
    ...
    // console.log(
    //     "🚀 ~ file: DyFormRender.tsx:63 ~ DynamicForm ~ selectedType:",
    //     selectedType
    // );
                        ...
                        {renderField(
                            key,
                            {
                                ...
                                ...(Array.isArray(value) && key === "enum"
                                    ? { defaultValue: value }
                                    : (Array.isArray(value) && key != "enum") || key === "isEditable" || key === "unique" || key === "required" || key === "many" || key === "ignoreGraphql" || key === "bcrypt"
                                        ? {}
                                        : { defaultValue: value }),
                            },
                            control,
